...
const BookingConfirmation: React.FC<BookingConfirmationProps> = ({
  ...
  const createBooking = async () => {
    try {
      ...
      const confirmedBooking = await bookingApiService.createBooking(
        bookingRequest
      );
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="space-y-1">
            ...
            <div className="text-sm text-white/70">
              ...
              to {bookingData.customerInfo.email}. Please check your inbox (and
              spam folder) for the complete details and preparation
              instructions.
            </div>
          </div>
        </div>
