...
import { useNailSalonSearch } from "../hooks/useNailSalonSearch";
import { Salon, FilterState } from "./HairSalonListing";

const NailSalonListing: React.FC = () => {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-purple-200 max-w-2xl mx-auto">
                Discover expert nail care and artistry in your area
              </p>
            </motion.div>
...
export default NailSalonListing;
