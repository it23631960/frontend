...
import { useBridalSalonSearch } from "../hooks/useBridalSalonSearch";
import { Salon, FilterState } from "./HairSalonListing";

const BridalSalonListing: React.FC = () => {
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                Bridal Services Near You
              </h1>
              <p className="text-xl text-purple-200 max-w-2xl mx-auto">
                Find the perfect bridal beauty services for your special day
              </p>
            </motion.div>
...
export default BridalSalonListing;
