...
import AdminSalonsPage from "./AdminSalonsPage";
...
const AdminLandingPage: React.FC = () => {
  ...
  const recentActivities = [
    ...
    },
    {
      ...
      type: "salon",
      icon: Building2,
      text: 'Salon "Glamour Studio" pending approval',
      time: "12 min ago",
      color: "pink",
    },
    {
      ...
      type: "booking",
      icon: Calendar,
      text: "15 new bookings completed",
      time: "28 min ago",
      color: "blue",
    },
    {
      ...
      type: "payment",
      icon: DollarSign,
      text: "Revenue milestone: $125K reached",
      time: "1 hour ago",
      color: "green",
    },
    {
      ...
      type: "report",
      icon: AlertCircle,
      text: "New report flagged for review",
      time: "2 hours ago",
      color: "yellow",
    },
  ];
  ...
  const pendingActions = [
    {
      title: "5 Salons awaiting approval",
      icon: Building2,
      count: 5,
      link: "/admin/salons?filter=pending",
      color: "purple",
    },
    {
      title: "12 Reports to review",
      icon: FileText,
      count: 12,
      link: "/admin/reports",
      color: "pink",
    ...
    {
      title: "3 Support tickets unresolved",
      icon: MessageSquare,
      count: 3,
      link: "/admin/support",
      color: "blue",
            ...
            <div className="space-y-4">
              {recentActivities.map((activity) => {
                ...
                return (
                  <div
                    key={activity.id}
                    className="flex items-start gap-4 p-3 bg-white/5 rounded-xl hover:bg-white/10 transition-all"
                  >
                    <div
                      className={`p-2 bg-${activity.color}-500/20 rounded-lg`}
                    >
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span
                      className={`text-2xl font-bold text-${action.color}-400`}
                    >
                      {action.count}
                    </span>
                  </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                to="/admin/users"
                className="text-purple-400 hover:text-pink-400 text-sm font-medium"
              >
                View All →
              </Link>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              return (
                ...
                >
                  <div
                    className={`p-3 bg-gradient-to-br from-${action.color}-500 to-${action.color}-600 rounded-xl group-hover:shadow-lg group-hover:shadow-${action.color}-500/50 transition-all`}
                  >
                    <Icon className="w-6 h-6 text-white" />
                  </div>
