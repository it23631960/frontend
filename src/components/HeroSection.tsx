    ...
    scale
      ...
      opacity
        ...
        delay: 0.2
          ...
          scale: 0.95
        }} className="bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:shadow-xl transition-all" onClick={scrollToNext}>
            Explore Services
          </motion.button>
        </motion.div>
        <motion.div initial={{
        ...
        repeatType: 'loop',
        delay: 1.5
      }} className="absolute bottom-10 left-1/2 transform -translate-x-1/2 cursor-pointer" onClick={scrollToNext}>
